...
_searchBar = SProxy
type ChildSlots = ( searchBar :: SearchBar.SelfSlot Unit)
...
cnDocumentationBlocks :: ∀ m. MonadAff m => H.ComponentHTML Action ChildSlots m
  ...
  , Documentation.block_
    ...
    [ Backdrop.backdrop_
      [ Backdrop.content_
        [ HH.div
          [ css "w-1/3 pb-6" ]
          [ HH.slot _searchBar unit SearchBar.component
